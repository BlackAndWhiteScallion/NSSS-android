.class final Lorg/chromium/mojom/mojo/ContentHandler_Internal$Stub;
...
# direct methods
.method constructor <init>(Lorg/chromium/mojo/system/Core;Lorg/chromium/mojom/mojo/ContentHandler;)V
    .locals 0
...
.method public accept(Lorg/chromium/mojo/bindings/Message;)Z
    ...
    .line 79
    :pswitch_1
    sget-object v4, Lorg/chromium/mojom/mojo/ContentHandler_Internal;->MANAGER:Lorg/chromium/mojo/bindings/Interface$Manager;
    ...
    invoke-static {v4}, Lorg/chromium/mojom/mojo/ContentHandler_Internal$ContentHandlerStartApplicationParams;->deserialize(Lorg/chromium/mojo/bindings/Message;)Lorg/chromium/mojom/mojo/ContentHandler_Internal$ContentHandlerStartApplicationParams;

    move-result-object v0

    .line 84
    .local v0, "data":Lorg/chromium/mojom/mojo/ContentHandler_Internal$ContentHandlerStartApplicationParams;
    invoke-virtual {p0}, Lorg/chromium/mojom/mojo/ContentHandler_Internal$Stub;->getImpl()Lorg/chromium/mojo/bindings/Interface;

    move-result-object v4

    check-cast v4, Lorg/chromium/mojom/mojo/ContentHandler;

    iget-object v6, v0, Lorg/chromium/mojom/mojo/ContentHandler_Internal$ContentHandlerStartApplicationParams;->application:Lorg/chromium/mojo/bindings/InterfaceRequest;

    iget-object v7, v0, Lorg/chromium/mojom/mojo/ContentHandler_Internal$ContentHandlerStartApplicationParams;->response:Lorg/chromium/mojom/mojo/UrlResponse;

    invoke-interface {v4, v6, v7}, Lorg/chromium/mojom/mojo/ContentHandler;->startApplication(Lorg/chromium/mojo/bindings/InterfaceRequest;Lorg/chromium/mojom/mojo/UrlResponse;)V
    :try_end_0
    ...
    .line 90
    .end local v0    # "data":Lorg/chromium/mojom/mojo/ContentHandler_Internal$ContentHandlerStartApplicationParams;
    .end local v2    # "header":Lorg/chromium/mojo/bindings/MessageHeader;
    .end local v3    # "messageWithHeader":Lorg/chromium/mojo/bindings/ServiceMessage;
    :catch_0
    move-exception v1
...
.method public acceptWithResponder(Lorg/chromium/mojo/bindings/Message;Lorg/chromium/mojo/bindings/MessageReceiver;)Z
    ...
    .line 106
    :pswitch_0
    invoke-virtual {p0}, Lorg/chromium/mojom/mojo/ContentHandler_Internal$Stub;->getCore()Lorg/chromium/mojo/system/Core;

    move-result-object v4

    sget-object v5, Lorg/chromium/mojom/mojo/ContentHandler_Internal;->MANAGER:Lorg/chromium/mojo/bindings/Interface$Manager;
