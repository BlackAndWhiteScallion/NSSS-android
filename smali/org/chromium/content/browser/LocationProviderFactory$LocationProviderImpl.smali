...
.field private static final TAG:Ljava/lang/String; = "cr.LocationProvider"
...
.method private ensureLocationManagerCreated()V
    ...
    .line 134
    const-string v0, "cr.LocationProvider"
...
.method private registerForLocationUpdates(Z)V
    ...
    const-string v1, "cr.LocationProvider"

    const-string v2, "Caught security exception while registering for location updates from the system. The application does not have sufficient geolocation permissions."
    ...
    invoke-static {v1}, Lorg/chromium/content/browser/LocationProviderAdapter;->newErrorAvailable(Ljava/lang/String;)V
